...
console.log(temperatureCtoF(24)); // Should print 75
...
console.log(makePersonObject(1, "Sandro", "sandrin@elemesmo.com"));
...
function getModelYears(years) {
  return years.map((car) => car.car_year);
}
